  ...
  function renderCategory(cat, subcat, subSubcat) {
    ...
    contentArea.innerHTML = `
      <section class="section">
        ...
        ${CATEGORY_INTROS[cat] ? '<p class="category-intro">' + CATEGORY_INTROS[cat] + '</p>' : ''}
        ${subPillsHTML}
        ${subSubPillsHTML}
      </section>
      ${bodyHTML}`;
